              ...
              <v-container>
                <v-row>
                  ...
                  <v-col cols="12" sm="6" md="6">
                    <v-text-field v-model="editedItem.nature_training" label="Nature of Training" color="success" outlined
                      dense class="mt-n8"></v-text-field>
                  </v-col>
                  <v-col cols="12" sm="6" md="6">
                    <v-text-field v-model="editedItem.place_training" label="Place of Training" color="success" outlined
                      dense class="mt-n8"></v-text-field>
                  </v-col>
                  <v-col cols="12" sm="6" md="6">
              ...
              <v-container>
                <v-row>
                  ...
                  <v-col cols="12" sm="12" md="12">
                    ...
                    <!-- <v-text-field v-model="editedItem.nature_training" label="Nature of Training" color="success" outlined
                      dense class="mt-n8" readonly></v-text-field> -->
                  </v-col>
                  <v-col cols="12" sm="12" md="12">
