        ...
        <v-data-table :headers="headers" :items="desserts" :search="search" class="btn-hover elevation-1 pa-4"  @click:row="editItem">
          ...
          <template v-slot:top>
            <v-dialog v-model="dialog" max-width="700px" tile>
              <v-card>
                <v-card-title>
                  <span class="text-h5">View Job Post</span>
                </v-card-title>
      ...
      <v-dialog v-model="dialog1" max-width="290">
        <v-card>
          ...
          <v-card-text class="mt-2">
            You have applied to this Job Post. Do you want to continue with the application process? If Yes, please
            press "Continue". All your data including your resume will be pass to the employer.
          </v-card-text>

          <v-card-actions>
            <v-spacer></v-spacer>

            <v-btn color="orange darken-1" text small @click="dialog1 = false">
              Cancel
            </v-btn>
