                  ...
                  <v-container>
                    <v-row>
                      <v-col cols="12" sm="12" md="8">
                        <v-text-field label="Establishment Name" required outlined dense :rules="[rules.required]"
                          color="green"></v-text-field>
                      </v-col>
                      <v-col cols="12" sm="12" md="4">
                        <v-text-field label="Acronym / Abbreviation" required outlined dense :rules="[rules.required]"
                          color="green"></v-text-field>
                      </v-col>
                  ...
                  <v-container fluid>
                    <v-row>
                      <v-col cols="12" sm="2" md="2">
                        <v-select :items="title" label="Title" outlined dense multiple small-chips :rules="[rules.required]"
                          color="green">
                        </v-select>
                      </v-col>
                      <v-col cols="12" sm="10" md="10">
                        <v-text-field label="Contact Person (Full Name)" required outlined dense :rules="[rules.required]"
                          color="green"></v-text-field>
                      </v-col>
                      ...
                      <v-col cols="12" sm="3" md="3">
                        <v-text-field label="Telephone Number" required type="number" outlined dense hide-spin-buttons 
                          color="green"></v-text-field>
                      </v-col>
                      <v-col cols="12" sm="3" md="3">
                        <v-text-field label="Mobile Number" required outlined dense type="number" :rules="[rules.required]" hide-spin-buttons
                          color="green"></v-text-field>
                      </v-col>
                      <v-col cols="12" sm="3" md="3">
                        <v-text-field label="E-mail Address" required outlined dense type="email" :rules="[rules.required]"
                          color="green"></v-text-field>
                      </v-col>
                    </v-row>
                  </v-container>
                    ...
                    <v-row>
                      <v-col cols="12" sm="12" md="6">
                        <v-file-input v-model="files" color="green accent-4" counter label="Business License" multiple
                          dense placeholder="Select your files" accept=".pdf, .docx" prepend-icon="mdi-paperclip" outlined :show-size="1000"
                          :rules="[rules.required]">
                        </v-file-input>
                      </v-col>
                      <v-col cols="12" sm="12" md="6">
                        <v-file-input v-model="files_permit" color="green accent-4" counter label="Business Permit"
                          multiple dense placeholder="Select your files" prepend-icon="mdi-paperclip" outlined accept=".pdf, .docx"
