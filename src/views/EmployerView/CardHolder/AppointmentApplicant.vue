                                ...
                                <v-dialog v-model="dialog" max-width="550px" tile>
                                    <v-card>
                                        ...
                                        <v-card-actions class="mt-n12">
                                            ...
                                            <!-- <v-btn color="green darken-1" dark @click="invitedApplicants(editedItem)"
                                                v-if="editedItem.remark !== 'Canceled'">
                                                Invite
                                            </v-btn>
                                            <v-btn color="green darken-1" dark @click="deleteItem(editedItem); (editedItem)"
                                                v-if="editedItem.remark == 'Canceled'">
                                                Remove
                                            </v-btn> -->
                                        </v-card-actions>
            ...
            <v-col md="6" cols="12">
                <v-card class="wrapper" color="#1B5E20">
                    <v-card-title class="subtitle-2">
                        ...
                        <v-spacer></v-spacer>
                        <v-spacer></v-spacer>
                        <v-text-field v-model="hiredsearch" append-icon="mdi-magnify" label="Search" single-line
                            hide-details outlined dark rounded dense></v-text-field>
                    </v-card-title>
                    <v-card-text>
                        <v-data-table :headers="hireheaders" :items="hired" :items-per-page="20" :search="hiredsearch"
                            ...
                            <template slot="item.remove" slot-scope="remove">
                                <v-btn text color="red" dark @click="() => removeInvited(remove.item)">
                                    <v-icon>
